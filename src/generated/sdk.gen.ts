...
export const nfcBadgeCredentialsCreate = <ThrowOnError extends boolean = false>(options: Options<NfcBadgeCredentialsCreateData, ThrowOnError>): RequestResult<NfcBadgeCredentialsCreateResponses, unknown, ThrowOnError> => (options.client ?? client).post<NfcBadgeCredentialsCreateResponses, unknown, ThrowOnError>({
    security: [{ name: 'X-Session-Token', type: 'apiKey' }],
...
export const nfcBadgeRevocationsRetrieve = <ThrowOnError extends boolean = false>(options: Options<NfcBadgeRevocationsRetrieveData, ThrowOnError>): RequestResult<NfcBadgeRevocationsRetrieveResponses, unknown, ThrowOnError> => (options.client ?? client).get<NfcBadgeRevocationsRetrieveResponses, unknown, ThrowOnError>({
    security: [{ name: 'X-Session-Token', type: 'apiKey' }],
    url: '/v1/nfc-badge/revocations',
    ...options
});

export const nfcBadgeWalletGoogleCreate = <ThrowOnError extends boolean = false>(options: Options<NfcBadgeWalletGoogleCreateData, ThrowOnError>): RequestResult<NfcBadgeWalletGoogleCreateResponses, unknown, ThrowOnError> => (options.client ?? client).post<NfcBadgeWalletGoogleCreateResponses, unknown, ThrowOnError>({
    security: [{ name: 'X-Session-Token', type: 'apiKey' }],
...
export const nfcBadgeWalletGoogleUpdate = <ThrowOnError extends boolean = false>(options: Options<NfcBadgeWalletGoogleUpdateData, ThrowOnError>): RequestResult<NfcBadgeWalletGoogleUpdateResponses, unknown, ThrowOnError> => (options.client ?? client).put<NfcBadgeWalletGoogleUpdateResponses, unknown, ThrowOnError>({
    security: [{ name: 'X-Session-Token', type: 'apiKey' }],
